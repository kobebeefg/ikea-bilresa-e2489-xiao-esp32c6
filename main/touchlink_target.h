...
#define ESP_ZIGBEE_TOUCHLINK_DEVICE_CHANNEL CONFIG_ZB_EXAMPLE_PRIMARY_CHANNEL
#define ESP_ZIGBEE_PRIMARY_CHANNEL_MASK     ((1U << ESP_ZIGBEE_TOUCHLINK_DEVICE_CHANNEL))

#define ESP_ZIGBEE_HA_ON_OFF_LIGHT_EP_ID (1)

#define ESP_ZIGBEE_STORAGE_PARTITION_NAME "zc_store"
